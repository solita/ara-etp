...
The agent is responsible for updating specification files under `.github/docs/` to reflect implemented changes in the codebase. It ensures documentation stays current and accurate.
