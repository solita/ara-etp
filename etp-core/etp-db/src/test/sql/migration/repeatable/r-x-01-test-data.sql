...
INSERT INTO audit.kayttaja VALUES
	(1, 762, '2026-02-13 05:36:55.793163+00', 0, 'database.etp', 0, 'database', 'etp', 'database@energiatodistusrekisteri.fi', '0501234567', false, -1, false, NULL, NULL, NULL, NULL, false, NULL, NULL, NULL, NULL),
	(2, 1001, '2026-02-13 05:37:01.50563+00', 0, 'database.etp', -1, 'conversion', 'etp', 'conversion@energiatodistusrekisteri.fi', '0501234567', false, -1, false, NULL, NULL, NULL, NULL, false, NULL, '', NULL, NULL),
	(3, 1001, '2026-02-13 05:37:01.50563+00', 0, 'database.etp', -2, 'laskutus', 'etp', 'laskutus@energiatodistusrekisteri.fi', '0501234567', false, -1, false, NULL, NULL, NULL, NULL, false, NULL, '', NULL, NULL),
	(4, 1001, '2026-02-13 05:37:01.50563+00', 0, 'database.etp', -3, 'communication', 'etp', 'communication@energiatodistusrekisteri.fi', '0501234567', false, -1, false, NULL, NULL, NULL, NULL, false, NULL, '', NULL, NULL),
	(5, 1001, '2026-02-13 05:37:01.50563+00', 0, 'database.etp', -4, 'presigned', 'etp', 'presigned@energiatodistusrekisteri.fi', '0501234567', false, -1, false, NULL, NULL, NULL, NULL, false, NULL, '', NULL, NULL),
	(6, 1001, '2026-02-13 05:37:01.50563+00', 0, 'database.etp', -5, 'aineisto', 'etp', 'aineisto@energiatodistusrekisteri.fi', '0501234567', false, -1, false, NULL, NULL, NULL, NULL, false, NULL, '', NULL, NULL),
	(7, 1001, '2026-02-13 05:37:01.50563+00', 0, 'database.etp', -6, 'expiration', 'etp', 'expiration@energiatodistusrekisteri.fi', '0501234567', false, -1, false, NULL, NULL, NULL, NULL, false, NULL, '', NULL, NULL),
...
INSERT INTO audit.laatija VALUES
	...
	(18, 1044, '2024-02-23 06:11:48.299734+00', 18, 'core.etp/api/private/laatijat', 21, 1, '2024-02-23', 'ARA', false, NULL, '{}', NULL, false, false, false, false, 0, 'Tiedottarkastamattakatu', NULL, '90000', 'Oulukai', 'FI', NULL, 'L000000017', true, false),
	(19, 1101, '2026-01-22 15:08:02.871153+00', 18, 'core.etp/api/private/laatijat/2', 2, 4, '2020-01-01', 'KIINKO', false, NULL, '{}', NULL, false, false, false, false, 0, 'Peltokatu 26', NULL, '33100', 'Tampere', 'FI', NULL, 'L000000001', false, false) ON CONFLICT DO NOTHING;
...
SELECT pg_catalog.setval('audit.laatija_event_id_seq', 19, true);
...
--
-- Data for Name: havainnointikayntityyppi; Type: TABLE DATA; Schema: etp; Owner: etp
--

INSERT INTO etp.havainnointikayntityyppi VALUES
	(0, 'Paikan päällä käynti', 'Paikan päällä käynti (sv)', true, 1, NULL),
	(1, 'Virtuaalikäynti', 'Virtuaalikäynti (sv)', true, 2, NULL) ON CONFLICT DO NOTHING;
...
INSERT INTO etp.kayttaja VALUES
	...
	(-1, 'conversion', 'etp', 'conversion@energiatodistusrekisteri.fi', '0501234567', false, -1, NULL, false, NULL, NULL, NULL, NULL, '2026-02-13 05:37:02.787393+00', false, NULL, '', NULL, NULL),
	(-2, 'laskutus', 'etp', 'laskutus@energiatodistusrekisteri.fi', '0501234567', false, -1, NULL, false, NULL, NULL, NULL, NULL, '2026-02-13 05:37:02.787393+00', false, NULL, '', NULL, NULL),
	(-3, 'communication', 'etp', 'communication@energiatodistusrekisteri.fi', '0501234567', false, -1, NULL, false, NULL, NULL, NULL, NULL, '2026-02-13 05:37:02.787393+00', false, NULL, '', NULL, NULL),
	(-4, 'presigned', 'etp', 'presigned@energiatodistusrekisteri.fi', '0501234567', false, -1, NULL, false, NULL, NULL, NULL, NULL, '2026-02-13 05:37:02.787393+00', false, NULL, '', NULL, NULL),
	(-5, 'aineisto', 'etp', 'aineisto@energiatodistusrekisteri.fi', '0501234567', false, -1, NULL, false, NULL, NULL, NULL, NULL, '2026-02-13 05:37:02.787393+00', false, NULL, '', NULL, NULL),
	(-6, 'expiration', 'etp', 'expiration@energiatodistusrekisteri.fi', '0501234567', false, -1, NULL, false, NULL, NULL, NULL, NULL, '2026-02-13 05:37:02.787393+00', false, NULL, '', NULL, NULL),
	(1, 'Pauli', 'Pätevyyden toteaja', 'patevyydentoteaja@solita.fi', '0451234567', false, 1, NULL, false, '010280-952L', NULL, NULL, NULL, '2026-02-13 05:37:02.787393+00', false, NULL, '', NULL, NULL),
	(4, 'Harri', 'Specimen-Potex', 'harri.lindberg@solita.fi', '0451234567', false, 0, NULL, false, '010675-9981', NULL, NULL, NULL, '2026-02-13 05:37:02.787393+00', false, NULL, '', NULL, NULL),
	(5, 'Aleksi', 'Kallan', 'aleksi.kallan@solita.fi', '0451234567', false, 0, NULL, false, '261298-998X', NULL, NULL, NULL, '2026-02-13 05:37:02.787393+00', false, NULL, '', NULL, NULL),
	(6, 'Ulla', 'Specimen-Pirix', 'ulla.laapotti@ara.fi', '0451234567', false, 0, NULL, false, '040265-9985', NULL, NULL, NULL, '2026-02-13 05:37:02.787393+00', false, NULL, '', NULL, NULL),
	(7, 'Kirsi', 'Juutilainen', 'kirsi.unhonen@ara.fi', '0451234567', false, 0, NULL, false, '260991-999R', NULL, NULL, NULL, '2026-02-13 05:37:02.787393+00', false, NULL, '', NULL, NULL),
	(8, 'Ari', 'Manninen', 'ari.manninen@ara.fi', '0451234567', false, 0, NULL, false, '010101-123N', NULL, NULL, NULL, '2026-02-13 05:37:02.787393+00', false, NULL, '', NULL, NULL),
	(9, 'Risto', 'Jesoi', 'risto.jesoi@ara.fi', '0451234567', false, 0, NULL, false, '180883-998N', NULL, NULL, NULL, '2026-02-13 05:37:02.787393+00', false, NULL, '', NULL, NULL),
	(10, 'Lamitor', 'Laatija', 'laatija@lamit.fi', '0451234567', false, 0, NULL, false, '110106A998M', NULL, NULL, NULL, '2026-02-13 05:37:02.787393+00', false, NULL, '', NULL, NULL),
	(11, 'Riuska', 'Laatija', 'laatija@granlund.fi', '0451234567', false, 0, NULL, false, '290574-9981', NULL, NULL, NULL, '2026-02-13 05:37:02.787393+00', false, NULL, '', NULL, NULL),
	(12, 'Cadmatic', 'Laatija', 'laatija@cadmatic.com', '0451234567', false, 0, NULL, false, '050391-999B', NULL, NULL, NULL, '2026-02-13 05:37:02.787393+00', false, NULL, '', NULL, NULL),
	(13, 'Timbal', 'Laatija', 'laatija@timbal.fi', '0451234567', false, 0, NULL, false, '120997-9998', NULL, NULL, NULL, '2026-02-13 05:37:02.787393+00', false, NULL, '', NULL, NULL),
	(14, 'Etlas', 'Laatija', 'laatija@etlas.fi', '0451234567', false, 0, NULL, false, '271258-9988', NULL, NULL, NULL, '2026-02-13 05:37:02.787393+00', false, NULL, '', NULL, NULL),
	(15, 'Caverion', 'Laatija', 'laatija@caverion.fi', '0451234567', false, 0, NULL, false, '010170-960F', NULL, NULL, NULL, '2026-02-13 05:37:02.787393+00', false, NULL, '', NULL, NULL),
	(16, 'Laskentapalvelut', 'Laatija', 'laatija@dof.fi', '0451234567', false, 0, NULL, false, '010170-999R', NULL, NULL, NULL, '2026-02-13 05:37:02.787393+00', false, NULL, '', NULL, NULL),
	(17, 'Laskentaohjelmat', 'Laatija', 'laatija@example.com', '0451234567', false, 0, NULL, false, '081181-9984', NULL, NULL, NULL, '2026-02-13 05:37:02.787393+00', false, NULL, '', NULL, NULL),
	(19, 'Paavo', 'Pääkäyttäjä', 'paakayttaja2@solita.fi', '0501234567', false, 2, NULL, false, NULL, NULL, 'vvirkamies3', 'testivirasto.fi', '2026-02-13 05:37:02.787393+00', false, NULL, '', NULL, NULL),
	(20, 'Lasse', 'Laskuttaja', 'laskuttaja@solita.fi', '0501234567', false, 3, NULL, false, NULL, NULL, 'vvirkamies2', 'testausvirasto.fi', '2026-02-13 05:37:02.787393+00', false, NULL, '', NULL, NULL),
	(3, 'Kalevi', 'Specimen-Potex', 'kumppani@solita.fi', '0451234568', false, 0, NULL, false, '141199-999N', NULL, NULL, NULL, '2026-02-13 05:37:02.787393+00', false, NULL, '', NULL, NULL),
	(18, 'Päivi', 'Pääkäyttäjä', 'paakayttaja@solita.fi', '0501234567', false, 2, '2026-01-22 15:07:44.700941+00', false, NULL, 'paakayttaja@solita.fi', 'vvirkamies', 'testivirasto.fi', '2026-02-13 05:37:02.787393+00', false, NULL, '', NULL, NULL),
	(2, 'Liisa', 'Specimen-Potex', 'laatija@solita.fi', '0451234567', false, 0, '2026-01-22 15:07:30.051703+00', false, '010469-999W', 'laatija@solita.fi', NULL, NULL, '2026-02-13 05:37:02.787393+00', false, NULL, '', NULL, NULL) ON CONFLICT DO NOTHING;
...
INSERT INTO etp.laatija VALUES
	...
	(21, 1, '2024-02-23', 'ARA', false, NULL, '{}', NULL, false, false, false, false, 0, 'Tiedottarkastamattakatu', NULL, '90000', 'Oulukai', 'FI', NULL, 'L000000017', true, false, '545f0a63-ad81-4168-ab95-7919e422ca24'),
	(2, 4, '2020-01-01', 'KIINKO', false, NULL, '{}', NULL, false, false, false, false, 0, 'Peltokatu 26', NULL, '33100', 'Tampere', 'FI', NULL, 'L000000001', false, false, '11b036aa-191e-4ec2-9d77-7bdc43886800') ON CONFLICT DO NOTHING;
...
--
-- Data for Name: perusparannuspassi_jaahdytys; Type: TABLE DATA; Schema: etp; Owner: etp
--

INSERT INTO etp.perusparannuspassi_jaahdytys VALUES
	(0, 'Ei ole', 'Ei ole (sv)', true, 1, NULL),
	(1, 'Aurinkosuojaukset', 'Aurinkosuojaukset (sv)', true, 2, NULL),
	(2, 'Muu', 'Muu (sv)', true, 3, NULL) ON CONFLICT DO NOTHING;


--
-- Data for Name: perusparannuspassi_liittymismahdollisuus; Type: TABLE DATA; Schema: etp; Owner: etp
--

INSERT INTO etp.perusparannuspassi_liittymismahdollisuus VALUES
	(0, 'Kyllä, kaukolämpöön', 'Kyllä, kaukolämpöön (sv)', true, 1, NULL),
	(1, 'Kyllä, Kaukojäähdytykseen', 'Kyllä, kaukolämpöön (sv)', true, 2, NULL),
	(2, 'Kyllä, molempiin', 'Kyllä, molempiin (sv)', true, 3, NULL),
	(3, 'Ei kumpaankaan', 'Ei kumpaankaan (sv)', true, 4, NULL) ON CONFLICT DO NOTHING;


--
-- Data for Name: perusparannuspassi_uusiutuva_energia; Type: TABLE DATA; Schema: etp; Owner: etp
--

INSERT INTO etp.perusparannuspassi_uusiutuva_energia VALUES
	(0, 'Ei ole', 'Ei ole (sv)', true, 1, NULL),
	(1, 'Aurinkosähkö', 'Aurinkosähkö (sv)', true, 2, NULL),
	(2, 'Aurinkolämpö', 'Aurinkolämpö (sv)', true, 3, NULL),
	(3, 'Aurinkosähkö ja -lämpö', 'Aurinkosähkö ja -lämpö (sv)', true, 4, NULL),
	(4, 'Tuulivoima', 'Tuulivoima (sv)', true, 5, NULL),
	(5, 'Muu', 'Muu (sv)', true, 6, NULL) ON CONFLICT DO NOTHING;


--
-- Data for Name: perusparannuspassi; Type: TABLE DATA; Schema: etp; Owner: etp
--



--
-- Data for Name: perusparannuspassi_vaihe; Type: TABLE DATA; Schema: etp; Owner: etp
--



--
-- Data for Name: toimenpide_ehdotus_group; Type: TABLE DATA; Schema: etp; Owner: etp
--

INSERT INTO etp.toimenpide_ehdotus_group VALUES
	(0, 'Lämmitys', 'Lämmitys (sv)', true, 1, NULL),
	(1, 'Lämmin käyttövesi', 'Lämmin käyttövesi (sv)', true, 2, NULL),
	(2, 'Ilmanvaihto', 'Ilmanvaihto (sv)', true, 3, NULL),
	(3, 'Valaistus', 'Valaistus (sv)', true, 4, NULL),
	(4, 'Jäähdytys', 'Jäähdytys (sv)', true, 5, NULL),
	(5, 'Uusiutuva energia', 'Uusiutuva energia (sv)', true, 6, NULL),
	(6, 'Ikkunat', 'Ikkunat (sv)', true, 7, NULL),
	(7, 'Ulko-ovet', 'Ulko-ovet (sv)', true, 8, NULL),
	(8, 'Yläpohja', 'Yläpohja (sv)', true, 9, NULL),
	(9, 'Alapohja', 'Alapohja (sv)', true, 10, NULL),
	(10, 'Julkisivu', 'Julkisivu (sv)', true, 11, NULL),
	(11, 'Muut toimenpiteet', 'Muut toimenpiteet (sv)', true, 12, NULL) ON CONFLICT DO NOTHING;


--
-- Data for Name: toimenpide_ehdotus; Type: TABLE DATA; Schema: etp; Owner: etp
--

INSERT INTO etp.toimenpide_ehdotus VALUES
	(0, 'Siirtyminen kaukolämpöön', 'Siirtyminen kaukolämpöön (sv)', true, 1, NULL, 0),
	(1, 'Maalämpöpumppu', 'Maalämpöpumppu (sv)', true, 2, NULL, 0),
	(2, 'Ilma-vesilämpöpumppu', 'Ilma-vesilämpöpumppu (sv)', true, 3, NULL, 0),
	(3, 'Poistoilmalämpöpumppu', 'Poistoilmalämpöpumppu (sv)', true, 4, NULL, 0),
	(4, 'Muu lämpöpumppu', 'Muu lämpöpumppu (sv)', true, 5, NULL, 0),
	(5, 'Hybridilämmitys', 'Hybridilämmitys (sv)', true, 6, NULL, 0),
	(6, 'Bioenergia', 'Bioenergia (sv)', true, 7, NULL, 0),
	(7, 'Muu lämmitystoimenpide', 'Muu lämmitystoimenpide (sv)', true, 8, NULL, 0),
	(8, 'Käyttövesivaraajan lisäys/muutos', 'Käyttövesivaraajan lisäys/muutos (sv)', true, 9, NULL, 1),
	(9, 'Vakiopaineventtiili', 'Vakiopaineventtiili (sv)', true, 10, NULL, 1),
	(10, 'Muu lämpimän käyttöveden toimenpide', 'Muu lämpimän käyttöveden toimenpide (sv)', true, 11, NULL, 1),
	(11, 'Koneellisen ilmanvaihdon muutos', 'Koneellisen ilmanvaihdon muutos (sv)', true, 12, NULL, 2),
	(12, 'Lämmöntalteenoton lisäys/parannus', 'Lämmöntalteenoton lisäys/parannus (sv)', true, 13, NULL, 2),
	(13, 'Ilmanvaihtokoneen uusiminen', 'Ilmanvaihtokoneen uusiminen (sv)', true, 14, NULL, 2),
	(14, 'Tarpeenmukainen ilmanvaihto', 'Tarpeenmukainen ilmanvaihto (sv)', true, 15, NULL, 2),
	(15, 'Muu ilmanvaihdon toimenpide', 'Muu ilmanvaihdon toimenpide (sv)', true, 16, NULL, 2),
	(16, 'Valaistuksen tehotiheyden muutos', 'Valaistuksen tehotiheyden muutos (sv)', true, 17, NULL, 3),
	(17, 'Tarpeenmukainen valaistus', 'Tarpeenmukainen valaistus (sv)', true, 18, NULL, 3),
	(18, 'Muu valaistuksen toimenpide', 'Muu valaistuksen toimenpide (sv)', true, 19, NULL, 3),
	(19, 'Siirtyminen kaukojäähdytykseen', 'Siirtyminen kaukojäähdytykseen (sv)', true, 20, NULL, 4),
	(20, 'Jäähdytyskoneen muutos/uusiminen', 'Jäähdytyskoneen muutos/uusiminen (sv)', true, 21, NULL, 4),
	(21, 'Passiivisen jäähdytyksen lisääminen', 'Passiivisen jäähdytyksen lisääminen (sv)', true, 22, NULL, 4),
	(22, 'Muu jäähdytystoimenpide', 'Muu jäähdytystoimenpide (sv)', true, 23, NULL, 4),
	(23, 'Aurinkosähkö', 'Aurinkosähkö (sv)', true, 24, NULL, 5),
	(24, 'Aurinkolämpö', 'Aurinkolämpö (sv)', true, 25, NULL, 5),
	(25, 'Tuulivoima', 'Tuulivoima (sv)', true, 26, NULL, 5),
	(26, 'Muu uusiutuvan energian toimenpide', 'Muu uusiutuvan energian toimenpide (sv)', true, 27, NULL, 5),
	(27, 'Muu ikkunatoimenpide', 'Muu ikkunatoimenpide (sv)', true, 29, NULL, 6),
	(28, 'Muu ulko-ovitoimenpide', 'Muu ulko-ovitoimenpide (sv)', true, 31, NULL, 7),
	(29, 'Muu yläpohjan toimenpide', 'Muu yläpohjan toimenpide (sv)', true, 33, NULL, 8),
	(30, 'Muu alapohjan toimenpide', 'Muu alapohjan toimenpide (sv)', true, 35, NULL, 9),
	(31, 'Tiiveyden parantaminen', 'Tiiveyden parantaminen (sv)', true, 37, NULL, 10),
	(32, 'Muu julkisivun toimenpide', 'Muu julkisivun toimenpide (sv)', true, 38, NULL, 10),
	(33, 'Energian varastointi', 'Energian varastointi (sv)', true, 39, NULL, 11),
	(34, 'Kulutusjousto', 'Kulutusjousto (sv)', true, 40, NULL, 11),
	(35, 'Varaavat tulisijat', 'Varaavat tulisijat (sv)', false, 36, NULL, 0),
	(36, 'Lämmönjaon hyötysuhteen muutos', 'Lämmönjaon hyötysuhteen muutos (sv)', false, 37, NULL, 0),
	(37, 'Lämmitysverkoston eristyksen muutos', 'Lämmitysverkoston eristyksen muutos (sv)', false, 38, NULL, 0),
	(38, 'Energiavaraajan muutos/lisäys', 'Energiavaraajan muutos/lisäys (sv)', false, 39, NULL, 0),
	(39, 'Lämmitysverkoston eristyksen muutos', 'Lämmitysverkoston eristyksen muutos (sv)', false, 40, NULL, 0),
	(40, 'Märkätilojen lämmityksen muutos', 'Märkätilojen lämmityksen muutos (sv)', false, 41, NULL, 0),
	(41, 'Lämmin käyttövesi', 'Lämmin käyttövesi (sv)', false, 42, NULL, 1),
	(42, 'Lämpimän käyttövesiverkoston eristyksen muutos', 'Lämpimän käyttövesiverkoston eristyksen muutos (sv)', false, 43, NULL, 1),
	(43, 'Lämpimän käyttöveden kiertojohdon muutos', 'Lämpimän käyttöveden kiertojohdon muutos (sv)', false, 44, NULL, 1),
	(44, 'Painovoimaisen IV:n muutos koneelliseksi', 'Painovoimaisen IV:n muutos koneelliseksi (sv)', false, 45, NULL, 2),
	(45, 'Jäteveden lämmöntalteenotto', 'Jäteveden lämmöntalteenotto (sv)', false, 46, NULL, 1),
	(46, 'Ikkunoiden uusiminen', 'Ikkunoiden uusiminen (sv)', true, 28, NULL, 6),
	(47, 'Ulko-ovien uusiminen', 'Ulko-ovien uusiminen (sv)', true, 30, NULL, 7),
	(48, 'Yläpohjan lisäeristys', 'Yläpohjan lisäeristys (sv)', true, 32, NULL, 8),
	(49, 'Alapohjan lisäeristys', 'Alapohjan lisäeristys (sv)', true, 34, NULL, 9),
	(50, 'Julkisivun lisäeristys', 'Julkisivun lisäeristys (sv)', true, 36, NULL, 10) ON CONFLICT DO NOTHING;


--
-- Data for Name: perusparannuspassi_vaihe_toimenpide_ehdotus; Type: TABLE DATA; Schema: etp; Owner: etp
--



--
-- Data for Name: ppp_vaihe_validation_numeric_column; Type: TABLE DATA; Schema: etp; Owner: etp
--

INSERT INTO etp.ppp_vaihe_validation_numeric_column VALUES
	('t$uusiutuvan_energian_hyodynnetty_osuus', 2026, 0, 100, 0, 100, true) ON CONFLICT DO NOTHING;


--
-- Data for Name: ppp_vaihe_validation_required_column; Type: TABLE DATA; Schema: etp; Owner: etp
--

INSERT INTO etp.ppp_vaihe_validation_required_column VALUES
	('tp$toimenpideseloste', 2026, 0, false, false),
	('tp$toimenpideseloste_fi', 2026, 0, true, false),
	('tp$toimenpideseloste_sv', 2026, 1, true, false),
	('t$ostoenergian_tarve_kaukolampo', 2026, 2, true, false),
	('t$ostoenergian_tarve_sahko', 2026, 3, true, false),
	('t$ostoenergian_tarve_uusiutuvat_pat', 2026, 4, true, false),
	('t$ostoenergian_tarve_fossiiliset_pat', 2026, 5, true, false),
	('t$ostoenergian_tarve_kaukojaahdytys', 2026, 6, true, false),
	('t$uusiutuvan_energian_kokonaistuotto', 2026, 7, true, false),
	('t$uusiutuvan_energian_hyodynnetty_osuus', 2026, 8, true, false) ON CONFLICT DO NOTHING;


--
-- Data for Name: ppp_validation_numeric_column; Type: TABLE DATA; Schema: etp; Owner: etp
--

INSERT INTO etp.ppp_validation_numeric_column VALUES
	('t$kaukolampo_hinta', 2026, 0, 20, 0, 200, true),
	('t$sahko_hinta', 2026, 0, 20, 0, 200, true),
	('t$uusiutuvat_pat_hinta', 2026, 0, 20, 0, 200, true),
	('t$fossiiliset_pat_hinta', 2026, 0, 20, 0, 200, true),
	('t$kaukojaahdytys_hinta', 2026, 0, 20, 0, 200, true),
	('rpt$ulkoseinat_ehdotettu_taso', 2026, 0.08, 0.81, 0.05, 2, true),
	('rpt$ylapohja_ehdotettu_taso', 2026, 0.05, 0.47, 0.03, 2, true),
	('rpt$alapohja_ehdotettu_taso', 2026, 0.05, 0.60, 0.03, 4, true),
	('rpt$ikkunat_ehdotettu_taso', 2026, 0.50, 3.10, 0.40, 6.5, true),
	('rpt$ulkoovet_ehdotettu_taso', 2026, 0.50, 2.20, 0.20, 6.5, true) ON CONFLICT DO NOTHING;


--
-- Data for Name: ppp_validation_required_column; Type: TABLE DATA; Schema: etp; Owner: etp
--

INSERT INTO etp.ppp_validation_required_column VALUES
	('ppt$havainnointikaynti', 2026, 0, true, false),
	('ppt$passin_esittely', 2026, 1, true, false),
	('rpt$ulkoseinat_ehdotettu_taso', 2026, 2, true, false),
	('rpt$ylapohja_ehdotettu_taso', 2026, 3, true, false),
	('rpt$alapohja_ehdotettu_taso', 2026, 4, true, false),
	('rpt$ikkunat_ehdotettu_taso', 2026, 5, true, false),
	('rpt$paalammitysjarjestelma_ehdotettu_taso', 2026, 6, true, false),
	('rpt$ilmanvaihto_ehdotettu_taso', 2026, 7, true, false),
	('rpt$uusiutuva_energia_ehdotettu_taso', 2026, 8, true, false),
	('rpt$jaahdytys_ehdotettu_taso', 2026, 9, true, false),
	('rpt$mahdollisuus_liittya_energiatehokkaaseen', 2026, 10, true, false),
	('t$kaukolampo_hinta', 2026, 11, true, false),
	('t$sahko_hinta', 2026, 12, true, false),
	('t$uusiutuvat_pat_hinta', 2026, 13, true, false),
	('t$fossiiliset_pat_hinta', 2026, 14, true, false),
	('t$kaukojaahdytys_hinta', 2026, 15, true, false) ON CONFLICT DO NOTHING;
...
--
-- Name: perusparannuspassi_id_seq; Type: SEQUENCE SET; Schema: etp; Owner: etp
--

SELECT pg_catalog.setval('etp.perusparannuspassi_id_seq', 1, false);
