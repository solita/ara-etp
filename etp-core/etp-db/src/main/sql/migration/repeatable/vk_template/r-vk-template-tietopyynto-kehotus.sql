...
<p>
  ...
  ja vuokraustilanteissa. Valvontamme perusteella myynnissä tai vuokrattavana olevaa rakennustanne/asuntoanne
  markkinoidaan julkisesti ilman energiatodistusta. Mikäli kohteen julkista markkinointia jatketaan tai se
  myydään, <b>Varke kehottaa esittämään energiatodistuksen {{määräpäivä}} mennessä sähköpostitse osoitteeseen
...
<p>
  Jos rakennuksen omistaja ei täytä laissa säädettyjä velvollisuuksiaan, Varke kehottaa
...
<p>
  ...
  energicertifikat vid försäljning och uthyrning. På basis av vår tillsyn marknadsförs
  den byggnad/bostad som ni ska sälja eller hyra ut offentligt utan
...
<p>
  Om byggnadens ägare inte uppfyller sin lagstadgade
