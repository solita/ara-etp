...
<p>Varke on lähettänyt teille tästä energiatodistuksesta valvontamuistion. Varke on valvontamuistiossa todennut, että
    energiatodistus voi olla olennaisesti virheellinen. <b>Varke kehottaa teitä korjaamaan energiatodistuksen {{määräpäivä}}
    mennessä.</b></p>
