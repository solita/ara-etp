...
<p>Varke har sänt er en begäran om inlämning av bakgrundsmaterial till detta energicertifikat. Varke ber er lämna in
    bakgrundsmaterialet inom en månad från datumet för denna uppmaning. <b>Varke kommer att kontrollera certifikatets
        riktighet på basis av detta material.</b> Vi ber er skicka följande bakgrundsmaterial som använts vid
    upprättandet av certifikatet till Varkes energicertifikatsregister senast {{määräpäivä}}:</p>
