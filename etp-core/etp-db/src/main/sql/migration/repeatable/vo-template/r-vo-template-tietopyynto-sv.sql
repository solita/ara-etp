...
<p><b>Varke kommer att kontrollera det här certifikatets riktighet.</b> Vi ber er skicka följande bakgrundsmaterial som
    använts vid upprättandet av certifikatet till Varkes energicertifikatsregister senast {{määräpäivä}}:</p>
<ul>
