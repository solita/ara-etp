...
(t/deftest signing-resets-unused-ilmastoselvitys
  (let [{:keys [laatijat]} (test-data-set)
        ...
        update (-> et-add
                 ...
                 (assoc-in [:ilmastoselvitys :yritys-postinumero] "00520")
                 (assoc-in [:ilmastoselvitys :yritys-postitoimipaikka] "Helsinki")
                 (assoc-in [:ilmastoselvitys :laadintaperuste] 1)
                 (assoc-in [:ilmastoselvitys :hiilijalanjalki :rakennus :rakennustuotteiden-valmistus] 1)
                 (assoc-in [:ilmastoselvitys :hiilijalanjalki :rakennus :kuljetukset-tyomaavaihe] 1)
                 (assoc-in [:ilmastoselvitys :hiilijalanjalki :rakennus :rakennustuotteiden-vaihdot] 1)
                 (assoc-in [:ilmastoselvitys :hiilijalanjalki :rakennus :energiankaytto] 1)
                 (assoc-in [:ilmastoselvitys :hiilijalanjalki :rakennus :purkuvaihe] 1)
                 (assoc-in [:ilmastoselvitys :hiilijalanjalki :rakennus :rakennustuotteiden-valmistus] 1)
                 (assoc-in [:ilmastoselvitys :hiilijalanjalki :rakennuspaikka :rakennustuotteiden-valmistus ] 1)
                 (assoc-in [:ilmastoselvitys :hiilijalanjalki :rakennuspaikka :kuljetukset-tyomaavaihe] 1)
                 (assoc-in [:ilmastoselvitys :hiilijalanjalki :rakennuspaikka :rakennustuotteiden-vaihdot ] 1)
                 (assoc-in [:ilmastoselvitys :hiilijalanjalki :rakennuspaikka :energiankaytto] 1)
                 (assoc-in [:ilmastoselvitys :hiilijalanjalki :rakennuspaikka :purkuvaihe] 1)
                 (assoc-in [:ilmastoselvitys :hiilikadenjalki :rakennus :uudelleenkaytto] 1)
                 (assoc-in [:ilmastoselvitys :hiilikadenjalki :rakennus :kierratys] 1)
                 (assoc-in [:ilmastoselvitys :hiilikadenjalki :rakennus :ylimaarainen-uusiutuvaenergia] 1)
                 (assoc-in [:ilmastoselvitys :hiilikadenjalki :rakennus :hiilivarastovaikutus] 1)
                 (assoc-in [:ilmastoselvitys :hiilikadenjalki :rakennus :karbonatisoituminen] 1)
                 (assoc-in [:ilmastoselvitys :hiilikadenjalki :rakennuspaikka :uudelleenkaytto] 1)
                 (assoc-in [:ilmastoselvitys :hiilikadenjalki :rakennuspaikka :kierratys] 1)
                 (assoc-in [:ilmastoselvitys :hiilikadenjalki :rakennuspaikka :ylimaarainen-uusiutuvaenergia] 1)
                 (assoc-in [:ilmastoselvitys :hiilikadenjalki :rakennuspaikka :hiilivarastovaikutus] 1)
                 (assoc-in [:ilmastoselvitys :hiilikadenjalki :rakennuspaikka :karbonatisoituminen] 1)
                 (assoc-in [:ilmastoselvitys :hiilikadenjalki :rakennus :hyodyntaminen-energiana] 1)
                 (assoc-in [:ilmastoselvitys :hiilikadenjalki :rakennuspaikka :hyodyntaminen-energiana] 1))]
    (service/update-energiatodistus! db whoami et-id update)
    (energiatodistus-test-data/sign! et-id laatija-id true)
    (let [signed (service/find-energiatodistus db et-id)]
      (t/is (nil? (get-in signed [:ilmastoselvitys :laatimisajankohta])))
      (t/is (nil? (get-in signed [:ilmastoselvitys :yritys])))
      (t/is (nil? (get-in signed [:ilmastoselvitys :yritys-osoite])))
      (t/is (nil? (get-in signed [:ilmastoselvitys :yritys-postinumero])))
      (t/is (nil? (get-in signed [:ilmastoselvitys :yritys-postitoimipaikka])))
      (t/is (nil? (get-in signed [:ilmastoselvitys :laadintaperuste])))
      (t/is (nil? (get-in signed [:ilmastoselvitys :hiilijalanjalki :rakennus :rakennustuotteiden-valmistus])))
      (t/is (nil? (get-in signed [:ilmastoselvitys :hiilijalanjalki :rakennus :kuljetukset-tyomaavaihe])))
      (t/is (nil? (get-in signed [:ilmastoselvitys :hiilijalanjalki :rakennus :rakennustuotteiden-vaihdot])))
      (t/is (nil? (get-in signed [:ilmastoselvitys :hiilijalanjalki :rakennus :energiankaytto])))
      (t/is (nil? (get-in signed [:ilmastoselvitys :hiilijalanjalki :rakennus :purkuvaihe])))
      (t/is (nil? (get-in signed [:ilmastoselvitys :hiilijalanjalki :rakennus :rakennustuotteiden-valmistus])))
      (t/is (nil? (get-in signed [:ilmastoselvitys :hiilijalanjalki :rakennuspaikka :kuljetukset-tyomaavaihe])))
      (t/is (nil? (get-in signed [:ilmastoselvitys :hiilijalanjalki :rakennuspaikka :rakennustuotteiden-vaihdot])))
      (t/is (nil? (get-in signed [:ilmastoselvitys :hiilijalanjalki :rakennuspaikka :energiankaytto])))
      (t/is (nil? (get-in signed [:ilmastoselvitys :hiilijalanjalki :rakennuspaikka :purkuvaihe])))
      (t/is (nil? (get-in signed [:ilmastoselvitys :hiilikadenjalki :rakennus :uudelleenkaytto])))
      (t/is (nil? (get-in signed [:ilmastoselvitys :hiilikadenjalki :rakennus :kierratys])))
      (t/is (nil? (get-in signed [:ilmastoselvitys :hiilikadenjalki :rakennus :ylimaarainen-uusiutuvaenergia])))
      (t/is (nil? (get-in signed [:ilmastoselvitys :hiilikadenjalki :rakennuspaikka :hiilivarastovaikutus])))
      (t/is (nil? (get-in signed [:ilmastoselvitys :hiilikadenjalki :rakennuspaikka :karbonatisoituminen])))
      (t/is (nil? (get-in signed [:ilmastoselvitys :hiilikadenjalki :rakennus :hyodyntaminen-energiana])))
      (t/is (nil? (get-in signed [:ilmastoselvitys :hiilikadenjalki :rakennuspaikka :hyodyntaminen-energiana]))))))

(t/deftest signing-with-finnish-removes-swedish-fields-in-energiatodistus
  (let [{:keys [laatijat]} (test-data-set)
        laatija-id (-> laatijat keys sort first)
        whoami {:id laatija-id :rooli 0}
        db (ts/db-user laatija-id)
        ...
        update (-> (energiatodistus-test-data/generate-add 2026 true)
                   ...
                   (assoc-in [:tulokset :kaytettavat-energiamuodot :kaukolampo] 20000M)
                   (assoc-in [:tulokset :kaytettavat-energiamuodot :sahko] 5000M)
                   (assoc-in [:perustiedot :tayttaa-aplus-vaatimukset] false)
                   (assoc-in [:perustiedot :tayttaa-a0-vaatimukset] false)
                   (assoc-in [:perustiedot :katuosoite-fi] "fi-osoite")
                   (assoc-in [:perustiedot :katuosoite-sv] "sv-osoite")
                   (assoc-in [:perustiedot :keskeiset-suositukset-fi] "fi-keskeiset")
                   (assoc-in [:perustiedot :keskeiset-suositukset-sv] "sv-keskeiset")
                   (assoc-in [:perustiedot :nimi-fi] "fi-nimi")
                   (assoc-in [:perustiedot :nimi-sv] "sv-nimi")
                   (assoc-in [:lahtotiedot :ilmanvaihto :kuvaus-fi] "fi-ilmanvaihto")
                   (assoc-in [:lahtotiedot :ilmanvaihto :kuvaus-sv] "sv-ilmanvaihto")
                   (assoc-in [:lahtotiedot :lammitys :lammitysmuoto-1 :kuvaus-fi] "fi-lammitys1")
                   (assoc-in [:lahtotiedot :lammitys :lammitysmuoto-1 :kuvaus-sv] "sv-lammitys1")
                   (assoc-in [:lahtotiedot :lammitys :lammitysmuoto-2 :kuvaus-fi] "fi-lammitys2")
                   (assoc-in [:lahtotiedot :lammitys :lammitysmuoto-2 :kuvaus-sv] "sv-lammitys2")
                   (assoc-in [:lahtotiedot :lammitys :lammonjako :kuvaus-fi] "fi-lammonjako")
                   (assoc-in [:lahtotiedot :lammitys :lammonjako :kuvaus-sv] "sv-lammonjako")
                   (assoc-in [:huomiot :alapohja-ylapohja :teksti-fi] "fi-alapohja")
                   (assoc-in [:huomiot :alapohja-ylapohja :teksti-sv] "sv-alapohja")
                   (assoc-in [:huomiot :iv-ilmastointi :teksti-fi] "fi-iv")
                   (assoc-in [:huomiot :iv-ilmastointi :teksti-sv] "sv-iv")
                   (assoc-in [:huomiot :lammitys :teksti-fi] "fi-huomio-lammitys")
                   (assoc-in [:huomiot :lammitys :teksti-sv] "sv-huomio-lammitys")
                   (assoc-in [:huomiot :valaistus-muut :teksti-fi] "fi-valaistus")
                   (assoc-in [:huomiot :valaistus-muut :teksti-sv] "sv-valaistus")
                   (assoc-in [:huomiot :ymparys :teksti-fi] "fi-ymparys")
                   (assoc-in [:huomiot :ymparys :teksti-sv] "sv-ymparys")
                   (assoc-in [:huomiot :suositukset-fi] "fi-suositukset")
                   (assoc-in [:huomiot :suositukset-sv] "sv-suositukset")
                   (assoc-in [:lisamerkintoja-fi] "fi-lisamerkintoja")
                   (assoc-in [:lisamerkintoja-sv] "sv-lisamerkintoja")
                   (assoc-in [:toteutunut-ostoenergiankulutus :lisatietoja-fi] "fi-to-lisatietoja")
                   (assoc-in [:toteutunut-ostoenergiankulutus :lisatietoja-sv] "sv-to-lisatietoja"))]
    (service/update-energiatodistus! db whoami et-id update)
    (energiatodistus-test-data/sign! et-id laatija-id true)
    (let [signed (service/find-energiatodistus db et-id)]
      (t/is (= "fi-osoite" (get-in signed [:perustiedot :katuosoite-fi])))
      (t/is (= "fi-ilmanvaihto" (get-in signed [:lahtotiedot :ilmanvaihto :kuvaus-fi])))
      (t/is (= "fi-lammitys1" (get-in signed [:lahtotiedot :lammitys :lammitysmuoto-1 :kuvaus-fi])))
      (t/is (= "fi-lammitys2" (get-in signed [:lahtotiedot :lammitys :lammitysmuoto-2 :kuvaus-fi])))
      (t/is (= "fi-lammonjako" (get-in signed [:lahtotiedot :lammitys :lammonjako :kuvaus-fi])))
      (t/is (= "fi-huomio-lammitys" (get-in signed [:huomiot :lammitys :teksti-fi])))
      (t/is (= "fi-valaistus" (get-in signed [:huomiot :valaistus-muut :teksti-fi])))
      (t/is (= "fi-lisamerkintoja" (get-in signed [:lisamerkintoja-fi])))
      (t/is (= "fi-to-lisatietoja" (get-in signed [:toteutunut-ostoenergiankulutus :lisatietoja-fi])))
      (t/is (nil? (get-in signed [:perustiedot :katuosoite-sv])))
      (t/is (nil? (get-in signed [:perustiedot :keskeiset-suositukset-sv])))
      (t/is (nil? (get-in signed [:perustiedot :nimi-sv])))
      (t/is (nil? (get-in signed [:lahtotiedot :ilmanvaihto :kuvaus-sv])))
      (t/is (nil? (get-in signed [:lahtotiedot :lammitys :lammitysmuoto-1 :kuvaus-sv])))
      (t/is (nil? (get-in signed [:lahtotiedot :lammitys :lammitysmuoto-2 :kuvaus-sv])))
      (t/is (nil? (get-in signed [:lahtotiedot :lammitys :lammonjako :kuvaus-sv])))
      (t/is (nil? (get-in signed [:huomiot :alapohja-ylapohja :teksti-sv])))
      (t/is (nil? (get-in signed [:huomiot :iv-ilmastointi :teksti-sv])))
      (t/is (nil? (get-in signed [:huomiot :lammitys :teksti-sv])))
      (t/is (nil? (get-in signed [:huomiot :valaistus-muut :teksti-sv])))
      (t/is (nil? (get-in signed [:huomiot :ymparys :teksti-sv])))
      (t/is (nil? (get-in signed [:huomiot :suositukset-sv])))
      (t/is (nil? (get-in signed [:lisamerkintoja-sv])))
      (t/is (nil? (get-in signed [:toteutunut-ostoenergiankulutus :lisatietoja-sv]))))))

(t/deftest signing-with-swedish-removes-finnish-fields-in-energiatodistus
  (let [{:keys [laatijat]} (test-data-set)
        laatija-id (-> laatijat keys sort first)
        whoami {:id laatija-id :rooli 0}
        db (ts/db-user laatija-id)
        ...
        update (-> (energiatodistus-test-data/generate-add 2026 true)
                 ...
                 (assoc-in [:toteutunut-ostoenergiankulutus :lisatietoja-fi] "fi-to-lisatietoja")
                 (assoc-in [:toteutunut-ostoenergiankulutus :lisatietoja-sv] "sv-to-lisatietoja")
                 (assoc-in [:huomiot :lammitys :toimenpide][{:nimi-fi "fi-toimenpide-1" :nimi-sv "sv-toimenpide-1"}])
                 (assoc-in [:huomiot :iv-ilmastointi :toimenpide] [{:nimi-fi "fi-iv-toimenpide-1" :nimi-sv "sv-iv-toimenpide-1"}
                                                                   {:nimi-fi "fi-iv-toimenpide-2" :nimi-sv "sv-iv-toimenpide-2"}
                                                                   {:nimi-fi "fi-iv-toimenpide-3" :nimi-sv "sv-iv-toimenpide-3"}]))]
    (service/update-energiatodistus! db whoami et-id update)
    (energiatodistus-test-data/sign! et-id laatija-id true)
    (let [signed (service/find-energiatodistus db et-id)
          lammitys-toimenpide (get-in signed [:huomiot :lammitys :toimenpide])
          iv-ilmastointi-toimenpide (get-in signed [:huomiot :iv-ilmastointi :toimenpide])]
      (t/is (= "sv-toimenpide-1" (get-in lammitys-toimenpide [0 :nimi-sv])))
      (t/is (= "sv-iv-toimenpide-1" (get-in iv-ilmastointi-toimenpide [0 :nimi-sv])))
      (t/is (= "sv-iv-toimenpide-2" (get-in iv-ilmastointi-toimenpide [1 :nimi-sv])))
      (t/is (= "sv-iv-toimenpide-3" (get-in iv-ilmastointi-toimenpide [2 :nimi-sv])))
      (t/is (= "sv-osoite" (get-in signed [:perustiedot :katuosoite-sv])))
      (t/is (= "sv-keskeiset" (get-in signed [:perustiedot :keskeiset-suositukset-sv])))
      (t/is (= "sv-nimi" (get-in signed [:perustiedot :nimi-sv])))
      (t/is (= "sv-ilmanvaihto" (get-in signed [:lahtotiedot :ilmanvaihto :kuvaus-sv])))
      (t/is (= "sv-lammitys1" (get-in signed [:lahtotiedot :lammitys :lammitysmuoto-1 :kuvaus-sv])))
      (t/is (= "sv-lammitys2" (get-in signed [:lahtotiedot :lammitys :lammitysmuoto-2 :kuvaus-sv])))
      (t/is (= "sv-lammonjako" (get-in signed [:lahtotiedot :lammitys :lammonjako :kuvaus-sv])))
      (t/is (= "sv-alapohja" (get-in signed [:huomiot :alapohja-ylapohja :teksti-sv])))
      (t/is (= "sv-iv" (get-in signed [:huomiot :iv-ilmastointi :teksti-sv])))
      (t/is (= "sv-huomio-lammitys" (get-in signed [:huomiot :lammitys :teksti-sv])))
      (t/is (= "sv-valaistus" (get-in signed [:huomiot :valaistus-muut :teksti-sv])))
      (t/is (= "sv-ymparys" (get-in signed [:huomiot :ymparys :teksti-sv])))
      (t/is (= "sv-suositukset" (get-in signed [:huomiot :suositukset-sv])))
      (t/is (= "sv-lisamerkintoja" (get-in signed [:lisamerkintoja-sv])))
      (t/is (= "sv-to-lisatietoja" (get-in signed [:toteutunut-ostoenergiankulutus :lisatietoja-sv])))
      (t/is (nil? (get-in signed [:perustiedot :katuosoite-fi])))
      (t/is (nil? (get-in signed [:perustiedot :keskeiset-suositukset-fi])))
      (t/is (nil? (get-in signed [:perustiedot :nimi-fi])))
      (t/is (nil? (get-in signed [:lahtotiedot :ilmanvaihto :kuvaus-fi])))
      (t/is (nil? (get-in signed [:lahtotiedot :lammitys :lammitysmuoto-1 :kuvaus-fi])))
      (t/is (nil? (get-in signed [:lahtotiedot :lammitys :lammitysmuoto-2 :kuvaus-fi])))
      (t/is (nil? (get-in signed [:lahtotiedot :lammitys :lammonjako :kuvaus-fi])))
      (t/is (nil? (get-in signed [:huomiot :alapohja-ylapohja :teksti-fi])))
      (t/is (nil? (get-in signed [:huomiot :iv-ilmastointi :teksti-fi])))
      (t/is (nil? (get-in signed [:huomiot :lammitys :teksti-fi])))
      (t/is (nil? (get-in signed [:huomiot :valaistus-muut :teksti-fi])))
      (t/is (nil? (get-in signed [:huomiot :ymparys :teksti-fi])))
      (t/is (nil? (get-in signed [:huomiot :suositukset-fi])))
      (t/is (nil? (get-in signed [:lisamerkintoja-fi])))
      (t/is (nil? (get-in signed [:toteutunut-ostoenergiankulutus :lisatietoja-fi]))))))

(t/deftest signing-with-finnish-resets-swedish-fields-in-perusparannuspassi
  (let [laatija-adds (map #(assoc % :patevyystaso 4) (laatija-test-data/generate-adds 1))
        ...
        et-id (-> (energiatodistus-test-data/generate-and-insert! 1 2026 true laatija-id)
                  keys
                  first)
        _ (service/update-energiatodistus!
            db whoami et-id
            (-> (energiatodistus-test-data/generate-add 2026 true)
                (assoc-in [:perustiedot :kieli] 0)
                (assoc-in [:perustiedot :laatimisvaihe] 2)))
        ppp-add (-> (perusparannuspassi-test-data/generate-add et-id)
                    (assoc-in [:passin-perustiedot :lisatietoja-fi] "fi-passi-lisatietoja")
                    (assoc-in [:passin-perustiedot :lisatietoja-sv] "sv-passi-lisatietoja")
                    (assoc-in [:rakennuksen-perustiedot :lisatietoja-fi] "fi-rakennus-lisatietoja")
                    (assoc-in [:rakennuksen-perustiedot :lisatietoja-sv] "sv-rakennus-lisatietoja")
                    (assoc-in [:tulokset :lisatietoja-fi] "fi-tulokset-lisatietoja")
                    (assoc-in [:tulokset :lisatietoja-sv] "sv-tulokset-lisatietoja")
                    (assoc-in [:vaiheet 0 :toimenpiteet :toimenpideseloste-fi] "fi-vaihe-seloste")
                    (assoc-in [:vaiheet 0 :toimenpiteet :toimenpideseloste-sv] "sv-vaihe-seloste"))
        ppp-id (:id (perusparannuspassi-service/insert-perusparannuspassi! db whoami ppp-add))]
  (energiatodistus-test-data/sign! et-id laatija-id true)
  (let [signed (service/find-energiatodistus db et-id)
        ppp (perusparannuspassi-service/find-perusparannuspassi db whoami ppp-id)]
    (t/is (= "fi-passi-lisatietoja" (get-in ppp [:passin-perustiedot :lisatietoja-fi])))
    (t/is (nil? (get-in ppp [:passin-perustiedot :lisatietoja-sv])))
    (t/is (= "fi-rakennus-lisatietoja" (get-in ppp [:rakennuksen-perustiedot :lisatietoja-fi])))
    (t/is (nil? (get-in ppp [:rakennuksen-perustiedot :lisatietoja-sv])))
    (t/is (= "fi-tulokset-lisatietoja" (get-in ppp [:tulokset :lisatietoja-fi])))
    (t/is (nil? (get-in ppp [:tulokset :lisatietoja-sv])))
    (t/is (= "fi-vaihe-seloste" (get-in ppp[:vaiheet 0 :toimenpiteet :toimenpideseloste-fi])))
    (t/is (nil? (get-in ppp [:vaiheet 0 :toimenpiteet :toimenpideseloste-sv])))
    )))

(t/deftest signing-with-swedish-resets-finnish-fields-in-perusparannuspassi
  (let [laatija-adds (map #(assoc % :patevyystaso 4) (laatija-test-data/generate-adds 1))
        laatija-ids (laatija-test-data/insert! laatija-adds)
        laatija-id (first laatija-ids)
        whoami {:id laatija-id :rooli 0 :patevyystaso 4}
    ...
    (let [signed (service/find-energiatodistus db et-id)
          ppp (perusparannuspassi-service/find-perusparannuspassi db whoami ppp-id)]
      (t/is (nil? (get-in ppp [:passin-perustiedot :lisatietoja-fi])))
      (t/is (= "sv-passi-lisatietoja"(get-in ppp [:passin-perustiedot :lisatietoja-sv])))
      (t/is (nil? (get-in ppp [:rakennuksen-perustiedot :lisatietoja-fi])))
      (t/is (="sv-rakennus-lisatietoja"(get-in ppp [:rakennuksen-perustiedot :lisatietoja-sv])))
      (t/is (nil? (get-in ppp [:tulokset :lisatietoja-fi])))
      (t/is (="sv-tulokset-lisatietoja" (get-in ppp [:tulokset :lisatietoja-sv])))
      (t/is (nil? (get-in ppp [:vaiheet 0 :toimenpiteet :toimenpideseloste-fi])))
      (t/is (="sv-vaihe-seloste" (get-in ppp [:vaiheet 0 :toimenpiteet :toimenpideseloste-sv])))
      )))
