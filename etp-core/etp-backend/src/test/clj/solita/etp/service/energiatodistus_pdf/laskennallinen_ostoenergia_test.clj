(ns solita.etp.service.energiatodistus-pdf.laskennallinen-ostoenergia-test
  (:require [clojure.test :as t]
            [solita.etp.service.energiatodistus-pdf.laskennallinen-ostoenergia :as sut]
...
(t/deftest ostoenergia-tiedot-shows-dash-when-nil-test
  ...
  (let [energiatodistus {:versio 2026
                         ...
                         :tulokset {:kaytettavat-energiamuodot {}
        ...
        result (sut/ostoenergia-tiedot {:energiatodistus energiatodistus
                                        :kieli :fi})]
...
(t/deftest uusiutuvan-energian-osuus-aurinkosahko-test
  (let [et (make-et 200
    ...
    (t/is (= "33 %" (sut/uusiutuvan-energian-osuus 2026 et)))))
...
(t/deftest uusiutuvan-energian-osuus-aurinkolampo-test
  (let [et (make-et 100
    ...
    (t/is (= "20 %" (sut/uusiutuvan-energian-osuus 2026 et)))))
...
(t/deftest uusiutuvan-energian-osuus-combined-test
  (let [et (make-et 250
    ...
    (t/is (= "30 %" (sut/uusiutuvan-energian-osuus 2026 et)))))
...
(t/deftest uusiutuvan-energian-osuus-excluded-types-test
  (let [et (make-et 200
    ...
    (t/is (= 100M (e-luokka-service/e-luku 2026 et)))
    (t/is (= "0 %" (sut/uusiutuvan-energian-osuus 2026 et)))))
...
(t/deftest uusiutuvan-energian-osuus-zero-nettoala-test
  (let [et (make-et 0
                    ...
                    {:aurinkosahko 5000 :tuulisahko 0 :aurinkolampo 0}
                    {:aurinkosahko 8000 :tuulisahko 0 :aurinkolampo 0})]
    (t/is (nil? (sut/uusiutuvan-energian-osuus 2026 et)))))
...
(t/deftest uusiutuvan-energian-osuus-rounding-test
  (let [et (make-et 100
    ...
    (t/is (= 80M (e-luokka-service/e-luku 2026 et)))
    (t/is (= "34 %" (sut/uusiutuvan-energian-osuus 2026 et)))))
...
(t/deftest uusiutuvan-energian-osuus-non-2026-versio-test
  (let [et (make-et 200
                    ...
                    {:aurinkosahko 8000 :tuulisahko 0 :aurinkolampo 0}
                    {:aurinkosahko 10000 :tuulisahko 0 :aurinkolampo 0})]
    (t/is (nil? (sut/uusiutuvan-energian-osuus 2018 et)))
    (t/is (nil? (sut/uusiutuvan-energian-osuus 2013 et)))))
