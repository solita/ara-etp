...
(def dvv-timestamp-service-issuer-cert (env-or-resource "DVV_TIMESTAMP_SERVICE_ISSUER_CERTIFICATE" nil))
...
(def dvv-timestamp-service-root-cert (env-or-resource "DVV_TIMESTAMP_SERVICE_ROOT_CERTIFICATE" nil))
