  ...
  (into
    ...
    (concat
      ...
      [[:both [:huomiot :lammitys :kayttoikaa-jaljella-arvio-vuosina]]
       ...
       [:both [:ilmastoselvitys :hiilijalanjalki :rakennus :yhteensa]]
...
(def anonymized-columns
  (concat
   ...
   [[:lisamerkintoja-fi]
    [:lisamerkintoja-sv]]
   ;; Adding new columns to the end of the CSV, so that they don't interfere with existing column order.
