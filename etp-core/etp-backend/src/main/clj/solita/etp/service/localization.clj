...
(def ppp-pdf-localization
  {:fi {:rakennuksen-nimi                  "Rakennuksen nimi"
   ...
   :sv {:rakennuksen-nimi                  "Byggnadens namn"
        ...
        ;; TODO: Onkohan nämä käännetty oikein? Tuo co2 on ainakin muuttunut suomenkielisessä...
        :energiankulutus-kustannukset-ja-co2-paastot-vaiheen-jalkeen "Energiförbrukning, kostnader och CO{subscript}-utsläpp efter fasen"
