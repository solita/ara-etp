context('Laatija', () => {
  ...
  describe('energiatodistukset', () => {
    ...
    it('should sign energiatodistus', () => {
      cy.intercept('https://localhost:53952/version', {
        version: 'dummy',
      ...
      cy.intercept('POST', 'https://localhost:53952/sign', {
        version: '1.1',
      ...
      cy.intercept(
        ...
        { statusCode: 200, body: 'energiatodistukset/energiatodistus-5-fi.pdf' }
      ).as('pdf');
    ...
    it('should change laskutettava yritys', () => {
      cy.intercept('https://localhost:3000/api/private/laatijat/2/yritykset', {
        statusCode: 200,
        body: [
          {
            id: 1,
      ...
      cy.intercept('https://localhost:3000/api/private/yritykset/1', {
        statusCode: 200,
        body: {
          verkkolaskuosoite: null,
          jakeluosoite: 'paavo',
          postitoimipaikka: 'paavo',
          ytunnus: '1111112-8',
          nimi: 'Paavon pesusieni',
          postinumero: '12345',
          laskutuskieli: 0,
          id: 1,
