...
export const type = {
  ...
  audit: { // valvonnan käsittely - auditoinnin tulokset + laatijan vastaus
    report: 7,
    reply: 8,
    order: 9,
    warning: 10
...
export const hasDocumentTemplate = R.propSatisfies(R.includes(R.__, [3, 5, 6, 7, 8, 10]), 'type-id');
export const isAuditCase = R.propSatisfies(R.gt(R.__, type.anomaly), 'type-id');

export const isAuditCaseToimenpideType = R.propSatisfies(R.includes(R.__, [3, 5, 6, 7, 9, 10, 11]), 'id');
