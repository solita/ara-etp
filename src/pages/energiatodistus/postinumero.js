...
export const formatPostinumero = (postinumerot, locale) => postinumero =>
  R.compose(
...
const validatePostinumero = postinumerot =>
  R.compose(Maybe.isSome, Maybe.findById(R.__, postinumerot), nro =>
    parseInt(nro)
  );
