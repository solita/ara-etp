...
const mockEnergiatodistus = R.compose(
  R.assocPath(['toteutunut-ostoenergiankulutus', 'ostettu-energia', 'kaukolampo-vuosikulutus'], Either.Right(Maybe.Some(18000))),
  R.assocPath(['toteutunut-ostoenergiankulutus', 'ostettu-energia', 'kokonaissahko-vuosikulutus'], Either.Right(Maybe.Some(12000))),
  R.assocPath(['toteutunut-ostoenergiankulutus', 'ostettu-energia', 'kaukojaahdytys-vuosikulutus'], Either.Right(Maybe.Some(400))),
  R.assocPath(['toteutunut-ostoenergiankulutus', 'ostetut-polttoaineet', 'kevyt-polttooljy'], Either.Right(Maybe.Some(800))),
  R.assocPath(['toteutunut-ostoenergiankulutus', 'ostetut-polttoaineet', 'pilkkeet-havu-sekapuu'], Either.Right(Maybe.Some(5))),
  R.assocPath(['toteutunut-ostoenergiankulutus', 'ostetut-polttoaineet', 'pilkkeet-koivu'], Either.Right(Maybe.Some(3))),
  R.assocPath(['toteutunut-ostoenergiankulutus', 'ostetut-polttoaineet', 'puupelletit'], Either.Right(Maybe.Some(500)))
