...
const mockEnergiatodistus = R.compose(
  R.assocPath(['tulokset', 'kaytettavat-energiamuodot', 'kaukolampo'], Either.Right(Maybe.Some(15000))),
  R.assocPath(['tulokset', 'kaytettavat-energiamuodot', 'sahko'], Either.Right(Maybe.Some(10000))),
  R.assocPath(['tulokset', 'kaytettavat-energiamuodot', 'uusiutuva-polttoaine'], Either.Right(Maybe.Some(800))),
  R.assocPath(['tulokset', 'kaytettavat-energiamuodot', 'fossiilinen-polttoaine'], Either.Right(Maybe.Some(500))),
  R.assocPath(['tulokset', 'kaytettavat-energiamuodot', 'kaukojaahdytys'], Either.Right(Maybe.Some(300)))
