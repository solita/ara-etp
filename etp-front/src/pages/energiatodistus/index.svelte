<script>
  ...
  import ExistingEnergiatodistus from './existing-energiatodistus.svelte';
  import NewEnergiatodistus from './new-energiatodistus.svelte';
...
<div class="sticky bottom-2 z-10 w-full">
